...
Notice that in this case the main file does not have a \verb|\bibliography{...}| command. Rather, each of the chapter contains this command (unless, of course, there are no citations in that chapter). Also notice that the \verb|sectionbib| option has been used.
